...
PROMPT_V1_NAME = "ong-xuan-son-rag-v1"
PROMPT_V2_NAME = "ong-xuan-son-rag-v2"


# ── 2. Định nghĩa 2 Prompt Templates ──────────────────────────────────────
SYSTEM_V1 = (
    "Bạn là trợ lý AI thân thiện. Chỉ dùng thông tin trong context để trả lời. "
    "Trả lời ngắn gọn, trực tiếp trong 2-4 câu. Nếu context không chứa câu trả lời, "
    "hãy nói rõ rằng bạn không tìm thấy thông tin.\n\n"
    "Context:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích AI. Chỉ sử dụng các facts trong context và không suy đoán. "
    "Trả lời có cấu trúc trong 3-5 câu: nêu kết luận chính, giải thích ngắn gọn, "
    "và chỉ ra giới hạn nếu context thiếu dữ liệu.\n\n"
    "Context:\n{context}"
)
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V1_NAME,
            object=PROMPT_V1,
            description="V1: trả lời ngắn gọn, trực tiếp",
        )
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2: chuyên gia, trả lời có cấu trúc",
        )
